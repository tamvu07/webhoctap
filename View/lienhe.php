...
<body>
  ...
  <div class="container contact-form">
    ...
    <hr>
     ...
     <div class="row" >
      <!-- start ben phai -->
      <div class="col-sm-6"  style="background-color: teal">
                    <div class="row justify-content-center">
          <div class="col-lg-8">
            <div class="entry__article">
              <p><h1 style="color:currentColor; ">xin chao</h1></p>
              ...
              <blockquote><p>“Email:THT@gmail.com”</p></blockquote>
              <blockquote>
                <p>Vũ Minh Tâm </p>
                <p>Điện Thoại : 0972732901</p>
              </blockquote>
            </div>
          </div>
        </div>
                  ...
                  <div class="post-list-small__img-holder">
                    <div class="thumb-container thumb-100">
                      <a href="single-post.html">
                        <img data-src="img/content/post_small/tuan.jpg" src="img/empty.png" alt="" class=" lazyload">
                      </a>
                    </div>
                  </div>
                  <div class="post-list-small__body">
                    <h3 class="post-list-small__entry-title">
                      <a href="#">Nguyễn Anh Tuân</a>
                    </h3>
              ...
              <li class="post-list-small__item">
                <article class="post-list-small__entry clearfix">
                  <div class="post-list-small__img-holder">
                    <div class="thumb-container thumb-100">
                      <a href="single-post.html">
                        <img data-src="img/content/post_small/tran.jpg" src="img/empty.png" alt="" class=" lazyload">
                      </a>
                    </div>
                  </div>
                  <div class="post-list-small__body">
                    <h3 class="post-list-small__entry-title">
                      <a href="#">Trần Thị Bảo Trân</a>
                    </h3>
                    <ul class="entry__meta">
                      <li class="entry__meta-author">
                        <span>by</span>
              ...
              <li class="post-list-small__item">
                <article class="post-list-small__entry clearfix">
                  <div class="post-list-small__img-holder">
                    <div class="thumb-container thumb-100">
                      <a href="single-post.html">
                        <img data-src="img/content/post_small/tam.jpg" src="img/empty.png" alt="" class=" lazyload">
                      </a>
                    </div>
                  </div>
                  <div class="post-list-small__body">
                    <h3 class="post-list-small__entry-title">
                      <a href="#">Vũ Minh Tâm</a>
                    </h3>
                    <ul class="entry__meta">
                      <li class="entry__meta-author">
                        <span>by</span>
